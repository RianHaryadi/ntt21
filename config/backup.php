...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 *
                 * Kode aplikasi tidak ikut di-backup karena sudah tersimpan di git —
                 * yang di-backup hanya data yang tidak bisa dipulihkan: database
                 * (dikonfigurasi di bawah) dan file upload user.
                 */
                'include' => [
     ...
     */
    'notifications' => [
        // Email hanya dikirim saat ada masalah — backup sukses tidak perlu notifikasi
        // agar kotak masuk admin tidak penuh laporan harian.
        'notifications' => [
